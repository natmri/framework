...
import type { BrandedService } from './instantiation'
...
export function registerSingleton<T, _Services extends BrandedService[]>(id: ServiceIdentifier<T>, descriptor: SyncDescriptor<any>): void
